...
export const metadata: Metadata = {
  title: "Des Pardes | Authentic Pakistani Heritage Dining in Saidpur Village",  description: "Discover authentic Pakistani cuisine and traditional hospitality at Des Pardes in historic Saidpur Village, Islamabad. Reserve your table for signature Karahi, Biryani, and BBQ specialties.",  keywords: "Pakistani restaurant Islamabad, authentic cuisine Saidpur Village, traditional dining, Karahi, Biryani, heritage restaurant",  metadataBase: new URL("https://despardes.com"),
  alternates: {
    canonical: "https://despardes.com"},
  openGraph: {
    title: "Des Pardes | Authentic Pakistani Heritage Dining",    description: "Experience generations of hospitality through our signature Pakistani specialties in the heart of historic Saidpur Village.",    url: "https://despardes.com",    siteName: "Des Pardes",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/people-having-dinner-luxurious-restaurants_23-2151081875.jpg",        alt: "Des Pardes Heritage Restaurant Interior"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "Des Pardes | Authentic Pakistani Heritage Dining",    description: "Discover authentic Pakistani cuisine at Des Pardes in Saidpur Village, Islamabad",    images: ["http://img.b2bpic.net/free-photo/people-having-dinner-luxurious-restaurants_23-2151081875.jpg"],
  },
  robots: {
    index: true,
    follow: true,
